...
import probeWorker from "../remote/pbkdf2-worker";
...
describe("remote PBKDF2 probe Worker", () => {
  ...
  it("runs one 600,000-iteration operation per endpoint with correct semantics", async () => {
