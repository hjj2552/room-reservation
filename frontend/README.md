...
전체 E2E는 Worker runner를 사용합니다. 이 runner가 disposable PostgreSQL, Worker adapter와 Vite를 함께 관리합니다.
...
E2E 범위와 test-data cleanup 정책은 [Frontend E2E 문서](../docs/admin-e2e.md)를 참고하세요.
