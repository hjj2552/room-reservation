...
const requiredFragments = [
  ...
  "CLOUDFLARE_WORKER_NAME: ${{ vars.CLOUDFLARE_PRODUCTION_WORKER_NAME }}",
  "CLOUDFLARE_INGRESS_RATE_LIMIT_NAMESPACE_ID: ${{ vars.CLOUDFLARE_PRODUCTION_INGRESS_RATE_LIMIT_NAMESPACE_ID }}",
  "CLOUDFLARE_READ_RATE_LIMIT_NAMESPACE_ID: ${{ vars.CLOUDFLARE_PRODUCTION_READ_RATE_LIMIT_NAMESPACE_ID }}",
  "CLOUDFLARE_WRITE_RATE_LIMIT_NAMESPACE_ID: ${{ vars.CLOUDFLARE_PRODUCTION_WRITE_RATE_LIMIT_NAMESPACE_ID }}",
