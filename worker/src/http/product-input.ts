...
export function parseUpdateSettings(body: unknown): UpdateSettingsCommand {
  ...
  return {
    ...
    specialApprovalStartTime: parseTime(requireString(input, "specialApprovalStartTime"), "specialApprovalStartTime"),
    specialApprovalEndTime: parseTime(requireString(input, "specialApprovalEndTime"), "specialApprovalEndTime"),
    ...
    specialApprovalDaysOfWeek: normalizeDays(input.specialApprovalDaysOfWeek, "specialApprovalDaysOfWeek", true),
