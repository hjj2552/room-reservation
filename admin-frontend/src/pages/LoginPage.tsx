...
import { useAdminSession, useLogin } from '../hooks/useAuth';
...
export function LoginPage() {
  ...
  const from = (location.state as { from?: Location } | null)?.from?.pathname || '/reservations';
    ...
    <main className="login-page">
      <section className="login-panel" aria-labelledby="login-title">
        <div>
          ...
          <p className="muted">예약 승인, 수정, 반복 예약 등록을 처리합니다.</p>
        </div>
