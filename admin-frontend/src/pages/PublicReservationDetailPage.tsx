...
import { useCancelPublicReservation, usePublicReservationDetail } from '../hooks/usePublicReservation';
import { formatDateTime } from '../utils/date';
import { maskEmail, maskName, maskPhone } from '../utils/privacyMasking';
    ...
    <main className="public-shell" aria-labelledby="public-reservation-detail-title">
      <div className="page-header">
        ...
        <div className="header-actions">
          ...
          <Link className="secondary-button" to="/public/reservations/new">
            시간표로 돌아가기
          </Link>
        </div>
      </div>
