...
- 실행 role: `<validation-database-role>`
- primary DB: `<validation-primary-database>`
- replay DB: `<validation-replay-database>`
- UAT Worker: `<disposable-worker-name>`
- Pages project: 기존 `<pages-project-name>`의 preview branch `<pages-preview-branch>`
