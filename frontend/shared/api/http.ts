...
const commonErrorMessages: Record<CommonApiErrorCode, string> = {
  ...
  OUTSIDE_OPERATING_DAYS: '예약 가능한 요일이 아닙니다. 운영 설정을 확인해 주세요.',
  OUTSIDE_OPERATING_HOURS: '예약 가능한 시간 안에서만 예약할 수 있습니다.',
  ...
  PUBLIC_CANCEL_PASSWORD_MISMATCH: '수정 및 취소용 비밀번호가 일치하지 않습니다.',
  PUBLIC_RESERVATION_PASSWORD_MISMATCH: '수정 및 취소용 비밀번호가 일치하지 않습니다.',
...
const fieldLabels: Record<string, string> = {
  ...
  semesterStartDate: '예약 가능 시작일',
  semesterEndDate: '예약 가능 종료일',
  openTime: '운영 시작 시간',
  closeTime: '운영 종료 시간',
  specialApprovalStartTime: '특별 허가 시작 시간',
  specialApprovalEndTime: '특별 허가 종료 시간',
  slotMinutes: '예약 단위',
  availableDaysOfWeek: '운영 요일',
  specialApprovalDaysOfWeek: '특별 허가 요일',
